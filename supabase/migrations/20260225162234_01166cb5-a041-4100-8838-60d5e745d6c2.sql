-- Corrige regra do Autopilot no disparo imediato do Radar
-- Quando auto_send=true, os matches novos entram automaticamente na fila (my_queue)
...
BEGIN
  ...
  -- Sempre recalcula os matches atuais do usuário
