...
export function JobDetailsDialog({ open, onOpenChange, job, planSettings, formatSalary, onAddToQueue }: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-7xl h-[100dvh] sm:h-auto max-h-[100dvh] flex flex-col p-0 gap-0 overflow-hidden border-0 sm:border text-left bg-slate-50/30">
        {/* HEADER PREMIUM */}
        <div className="p-4 sm:p-6 bg-white border-b sticky top-0 z-50 shrink-0 shadow-sm">
          <div className="flex justify-between items-start">
            <div className="flex flex-col gap-1 w-full min-w-0">
              ...
              <DialogTitle className="text-xl sm:text-3xl leading-tight text-primary font-bold tracking-tight truncate">
        ...
        <div className="flex-1 overflow-y-auto touch-auto">
          <div className="p-4 sm:p-6 space-y-6 pb-32 sm:pb-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              {/* COLUNA ESQUERDA (CARDS TÉCNICOS) */}
              <div className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-black text-green-700 tracking-tight" translate="no">
                ...
                {/* CARD CONTATOS (COM BLUR E TRAVA) */}
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4 relative overflow-hidden">
                  ...
                  <div className="space-y-4 mt-2">
                    <div translate="no">
                      ...
                      <div className="font-mono text-sm bg-slate-50 p-3 rounded border border-slate-100 break-all">
              ...
              {/* COLUNA DIREITA (DESCRIÇÃO LINEAR) */}
        ...
        {/* FOOTER MOBILE (PADRONIZADO) */}
        <div className="sm:hidden p-4 border-t bg-white flex gap-3 sticky bottom-0 z-50 shadow-2xl">
          <Button
          ...
          <Button variant="outline" size="icon" className="h-12 w-12 border-slate-200">
