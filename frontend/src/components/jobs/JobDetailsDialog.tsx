...
export function JobDetailsDialog({
  ...
  // Só mostramos "Certified Opportunity" se já foi Early Access mas AGORA não é mais
                ...
                {job?.visa_type && (
                  <Badge
                    className={cn(
                      ...
                      // Early Access ou Histórico Early Access
        ...
        <div className="flex-1 overflow-y-auto bg-slate-50/30 touch-auto">
          <div className="p-4 sm:p-6 space-y-6 pb-32 sm:pb-6">
            <div className="space-y-4">
              {/* 1. AVISO EARLY ACCESS ATIVO (PRIORIDADE) */}
              {isCurrentlyEarlyAccess && (
            ...
            {/* 3. CARD HISTÓRICO (SÓ APARECE SE NÃO FOR MAIS EARLY ACCESS) */}
