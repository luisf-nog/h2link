      ...
      <DialogContent className="sm:max-w-7xl max-h-[95vh] flex flex-col p-0 gap-0 overflow-hidden rounded-none sm:rounded-lg">
        <DialogHeader className="p-4 sm:p-6 pb-4 bg-white border-b sticky top-0 z-10 shadow-sm">
          ...
          <div className="flex flex-col gap-2">
            ...
            {/* --- BANNER DE MERCHAN RECOLHÍVEL (MOBILE OPTIMIZED) --- */}
            {job?.was_early_access && (
              <div className="mt-4 rounded-xl border border-amber-100 bg-amber-50/30 overflow-hidden transition-all duration-300">
                <div
                  className="p-3 flex items-center justify-between cursor-pointer hover:bg-amber-100/50"
                ...
                {isBannerExpanded && (
                  <div className="px-3 pb-4 pt-0 animate-in fade-in slide-in-from-top-1 duration-200">
                    <p className="text-[11px] sm:text-xs text-amber-800 leading-relaxed max-w-3xl ml-11">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-5">
                ...
                <div>
                  <div className="flex items-center gap-2 text-green-700 font-bold text-base sm:text-lg mb-2">
                    ...
                    <span>{t("jobs.details.remuneration", "Compensation")}</span>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-2">
                    <Button variant="outline" size="sm" className="h-9 text-[11px] sm:text-xs" asChild>
                      <a href={`tel:${job.phone}`}>
                        <Phone className="h-3.5 w-3.5 mr-1" /> {t("jobs.details.call_action", "Call")}
                      </a>
                    </Button>
                    <Button variant="outline" size="sm" className="h-9 text-[11px] sm:text-xs" asChild>
              ...
              {job?.job_min_special_req && (
                <div className="bg-amber-50 rounded-xl border border-amber-200 p-5 sm:p-6 shadow-sm">
                  <h4 className="flex items-center gap-2 font-bold text-amber-900 mb-3 sm:mb-4 text-lg sm:text-xl">
                    ...
                    {t("jobs.details.special_reqs", "Special Requirements")}
                  </h4>
