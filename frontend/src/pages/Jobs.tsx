      ...
      <div className="space-y-6">
        ...
        {queuedJobIds.size > 0 && (
          <div className="animate-in fade-in slide-in-from-top-2 duration-300">
            <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-3 sm:p-4 mb-6 flex items-center justify-between gap-4 shadow-sm group transition-all hover:bg-blue-50">
              <div className="flex items-center gap-3 overflow-hidden text-left">
                ...
                <div className="min-w-0">
                  <h3 className="text-blue-900 font-bold text-sm sm:text-base leading-tight">Vagas aguardando envio</h3>
                  <p className="text-blue-700/60 text-xs truncate font-medium">
                    Você tem{" "}
                    <span translate="no" className="text-blue-700 font-bold">
                      {queuedJobIds.size}
                    </span>{" "}
                    itens prontos. Envie agora!
                  </p>
                </div>
              </div>
              <Button
                ...
                size="sm"
                className="shrink-0 bg-blue-600 hover:bg-blue-700 text-white font-bold h-10 px-5 sm:px-8 rounded-lg transition-all active:scale-95 flex items-center gap-2"
              >
                <span className="hidden sm:inline font-black">ENVIAR AGORA</span>
                <span className="sm:hidden font-black">ENVIAR</span>
