                          ...
                          {(() => {
                            ...
                            return (
                              <div className="flex flex-col items-start gap-1">
                                <Badge
                                  variant={b.variant}
                                  className={cn(b.className, wasEarly && "border-2 border-indigo-400 shadow-sm")}
                                >
                                  <div className="flex items-center gap-1">
                                    {wasEarly && (
                                      <Tooltip>
                                        ...
                                        <TooltipContent>
                                          <p>Detectada via Early Access!</p>
                                        </TooltipContent>
                                      </Tooltip>
                                    )}
                                    {b.label}
                                ...
                                {wasEarly && (
                                  <span className="text-[9px] font-bold text-indigo-600 uppercase flex items-center gap-0.5 ml-1">
