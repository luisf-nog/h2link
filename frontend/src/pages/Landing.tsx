          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
            <div style={{ maxWidth: 640, marginBottom: 56 }}>
              ...
              <p style={{ marginTop: 14, fontSize: 15, color: "rgba(255,255,255,0.50)", lineHeight: 1.7 }}>
                Resultados reais de gente real — mais candidaturas, menos trabalho manual.
              </p>
            </div>
                ...
                return (
                  <div key={t.name} className="testi-card" style={{ padding: "28px 24px" }}>
                    ...
                    <div style={{ marginTop: 18, color: "rgba(255,255,255,0.62)", fontSize: 14, lineHeight: 1.75 }}>
                      <span style={{ color: "rgba(255,255,255,0.25)", fontWeight: 900, marginRight: 6 }}>“</span>
                      {t.quote}
                      <span style={{ color: "rgba(255,255,255,0.25)", fontWeight: 900, marginLeft: 6 }}>”</span>
                    </div>
                  </div>
                );
              })}
