              ...
              >
                ...
                >
                  {(() => {
                    ...
                    if (lang.startsWith("pt")) return <>R$64<span style={{ fontSize: 28, fontWeight: 500, color: "rgba(255,255,255,0.4)" }}>,99</span></>;
                    if (lang.startsWith("es")) return <>US$19<span style={{ fontSize: 28, fontWeight: 500, color: "rgba(255,255,255,0.4)" }}>.99</span></>;
                    return <>$19<span style={{ fontSize: 28, fontWeight: 500, color: "rgba(255,255,255,0.4)" }}>.99</span></>;
                  })()}
                </div>
                <div
                  style={{
